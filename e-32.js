...
var current_users = ["roshni", "Maha", "Nahel", "Hira", "Areeba", "Mahnoor", "Kiran"];
var new_users = ["Muskan", "Iqra", "Sumaiya", "maha", "Roshni"];
...
new_users.forEach(function (new_user) {
    ...
    var userNameTaken = current_users.some(function (current_users) { return current_users.toLowerCase() === new_userLower; }); // true or false
